...
pub const MAX_BPF_LINK_TYPE: bpf_link_type = 9;
...
pub const __BPF_FUNC_MAX_ID: bpf_func_id = 194;
...
extern "C" {
    pub static _bpf_helper_func_names: [*const ::std::os::raw::c_char; 194usize];
}
extern "C" {
